...
type Handler func(ctx context.Context,
	reqHeader *head.WebReqHeader, reqBodyBuf []byte) (rsp interface{}, err error)
...
func apiHandle(ctx context.Context, handler Handler, msg *cc.Msg, reqBody []byte) (rsp interface{}, err error) {
	reqHeader := msg.ServerReqHead().(*head.WebReqHeader)
...
func initLogger(msg *cc.Msg, h *head.WebReqHeader) {
	remote := ""
	...
	filed = append(filed, logger.Field{"userid", h.Userid})
